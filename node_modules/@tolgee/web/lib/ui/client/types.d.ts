...
type OperationSchema<Url extends keyof Paths, Method extends keyof Paths[Url], Paths = paths> = Paths[Url][Method] extends OperationSchemaType ? Paths[Url][Method] : never;
export {};
